...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, KafkaUser> registerKafkaTemplate() {
        ...
        ProducerFactory<String, KafkaUser> registerProducerFactory = new DefaultKafkaProducerFactory<>(configProps);
